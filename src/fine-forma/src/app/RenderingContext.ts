...
export class RenderingContext implements IRenderingContext {
    ...
    setStrokeStyle(color: IColorPreview): void {
        this._context.strokeStyle = this._colorPreviewToHtml(color);
    }
    ...
    setFillStyle(color: IColorPreview): void {
        this._context.fillStyle = this._colorPreviewToHtml(color);
    }
    ...
    private _colorPreviewToHtml(preview: IColorPreview): string {
